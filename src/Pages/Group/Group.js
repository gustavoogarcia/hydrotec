...
export default function Group () {
  const { groupSearchFieldsState, groupSearchFields } = constants;
  ...
  const [fields, setFields] = useState(groupSearchFieldsState);
  const searchFields = groupSearchFields({fields});
