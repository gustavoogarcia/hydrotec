...
export default function PlantingLots () {
  ...
  useEffect(() => {
    setList([
      ...
      { id: 2134, date: new Date(), greenHouse: 'Estufa Azul', greenery: 'Cebolinha', harvestForecast: new Date() },
      { id: 3124, date: new Date(), greenHouse: 'Estufa Amarela', greenery: 'Erva doce', harvestForecast: new Date() },
      { id: 4212, date: new Date(), greenHouse: 'Estufa Amarela', greenery: 'Salsinha', harvestForecast: new Date() },
      { id: 5213, date: new Date(), greenHouse: 'Estufa Amarela', greenery: 'Acelga', harvestForecast: new Date() },
      { id: 1234, date: new Date(), greenHouse: 'Estufa Azul', greenery: 'Alface', harvestForecast: new Date() },
      { id: 2134, date: new Date(), greenHouse: 'Estufa Azul', greenery: 'Cebolinha', harvestForecast: new Date() },
      { id: 3124, date: new Date(), greenHouse: 'Estufa Amarela', greenery: 'Erva doce', harvestForecast: new Date() },
      { id: 4212, date: new Date(), greenHouse: 'Estufa Amarela', greenery: 'Salsinha', harvestForecast: new Date() },
